    ...
    <Box id="about">
      <WhiteBlock description="SOME INFO" header="SOME INFO">
        <Text>
          ...
          <br />
          It has all began back in 2018 when I was working as marketing manager.
          I couldn't find any reliable website developer so I've started
          "developing" websites on pagebuilders on my own. I just felt for it
          and also made some websites for a few first customers.
          <br /> It became serious on April 2020 when I started to deep dive
          into website development. Since then I've done a lot of websites. Then
          I felt in love with <strong>React</strong>.<br />
          <br /> Iam successful{" "}
          <strong>
            {" "}
            2021{" "}
          ...
          where I've gained team & company development experience. <br /> <br />{" "}
          <strong>
